                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('razorpay_description', Utility::getsettings('razorpay_description'), ['class' => 'form-control', 'id' => 'razorpay_description', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paypal_description', Utility::getsettings('paypal_description'), ['class' => 'form-control', 'id' => 'paypal_description', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('flutterwave_description', Utility::getsettings('flutterwave_description'), ['class' => 'form-control', 'id' => 'flutterwave_description', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paystack_description', Utility::getsettings('paystack_description'), ['class' => 'form-control', 'id' => 'paystack_description', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payfast_signature', Utility::getsettings('payfast_signature'), ['class' => 'form-control', 'id' => 'payfast_signature', 'placeholder' => __('Enter payfast signature')]) }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            {{ Form::label('payfast_merchant_id', __('Payfast Id'), ['class' => 'col-form-label']) }}
                                                                            {{ Form::text('payfast_merchant_id', Utility::getsettings('payfast_merchant_id'), ['class' => 'form-control', 'id' => 'payfast_merchant_id', 'placeholder' => __('Enter payfast id')]) }}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payfast_merchant_key', Utility::getsettings('payfast_merchant_key'), ['class' => 'form-control', 'id' => 'payfast_merchant_key', 'placeholder' => __('Enter payfast key')]) }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            {{ Form::label('payfast_description', __('PayFast Description'), ['class' => 'col-form-label']) }}
                                                                            {{ Form::text('payfast_description', Utility::getsettings('payfast_description'), ['class' => 'form-control', 'id' => 'payfast_description', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('sspay_description', Utility::getsettings('sspay_description'), ['class' => 'form-control ', 'placeholder' => __('Enter description')]) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
